...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        ...
        slug: "carene",
        description:
          "Waterman's flagship luxury fountain pen featuring a distinctive inlaid 18k gold nib that flows seamlessly into the barrel. The Carène is named after the French word for 'hull' and features a sleek, ship-inspired silhouette. A statement pen with exceptional writing character and one of the most recognizable designs in the fountain pen world.",
        nibOptions: ["Fine", "Medium", "Broad"],
        fillingSystem: "Cartridge / Converter",
        material: "Lacquer / Stainless steel / 18k gold nib",
        knownPrices: [
          { retailer: "Amazon", price: 295.00, currency: "USD", url: "https://www.amazon.com/s?k=Waterman+Car%C3%A8ne+fountain+pen", inStock: true, condition: "new" },
          { retailer: "Goulet Pens", price: 380.00, currency: "USD", url: "https://www.gouletpens.com/search?q=waterman+carene", inStock: true, condition: "new" },
          { retailer: "Goldspot Pens", price: 350.00, currency: "USD", url: "https://www.goldspot.com/waterman/carene/", inStock: true, condition: "new" },
        ],
        msrp: 380,
        yearIntroduced: 1997,
      },
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        ...
        slug: "vector",
        description:
          "Parker's most affordable fountain pen and one of their best-selling models worldwide. The Vector features a slim stainless steel body, a smooth steel nib, and Parker's signature arrow clip. Available in a wide range of colors and finishes, it is a popular choice for students, everyday writers, and anyone seeking Parker quality at an entry-level price.",
        nibOptions: ["Fine", "Medium"],
        fillingSystem: "Cartridge / Converter (Quink)",
        material: "Stainless steel / Brass",
        knownPrices: [
          { retailer: "Amazon", price: 15.00, currency: "USD", url: "https://www.amazon.com/s?k=Parker+Vector+fountain+pen", inStock: true, condition: "new" },
          { retailer: "Goldspot Pens", price: 20.00, currency: "USD", url: "https://www.goldspot.com/parker/vector/", inStock: true, condition: "new" },
          { retailer: "Goulet Pens", price: 20.00, currency: "USD", url: "https://www.gouletpens.com/search?q=parker+vector", inStock: true, condition: "new" },
        ],
        msrp: 20,
        yearIntroduced: 1996,
      },
  ...
  {
    id: "ferris-wheel-press",
    name: "Ferris Wheel Press",
    slug: "ferris-wheel-press",
    country: "Canada",
    description:
      "Founded in 2016 in Markham, Ontario, Ferris Wheel Press is a Canadian stationery brand that has quickly risen to popularity through whimsical, art-deco-inspired designs and a strong social media presence. Known for their distinctive hexagonal pen bodies, ornate packaging, and vibrant ink colors, they have become a favorite among fountain pen enthusiasts who value aesthetics and personality.",
    website: "https://www.ferriswheelpress.com",
    models: [
      {
        id: "fwp-cricket",
        name: "Cricket",
        slug: "cricket",
        description:
          "Ferris Wheel Press's popular entry-level fountain pen. The Cricket features a hexagonal aluminum body, a smooth JoWo #5 steel nib, and a screw cap with a distinctive finial. Available in a wide range of pastel and metallic colors. A compact, lightweight pen that punches above its price point with excellent build quality and a satisfying writing experience.",
        nibOptions: ["Extra Fine", "Fine", "Medium", "Broad"],
        fillingSystem: "Cartridge / Converter",
        material: "Anodized aluminum",
        knownPrices: [
          { retailer: "Amazon", price: 32.00, currency: "USD", url: "https://www.amazon.com/s?k=Ferris+Wheel+Press+Cricket+fountain+pen", inStock: true, condition: "new" },
          { retailer: "Goulet Pens", price: 38.00, currency: "USD", url: "https://www.gouletpens.com/search?q=ferris+wheel+press+cricket", inStock: true, condition: "new" },
          { retailer: "Goldspot Pens", price: 36.00, currency: "USD", url: "https://www.goldspot.com/ferris-wheel-press/cricket/", inStock: true, condition: "new" },
        ],
        msrp: 38,
        yearIntroduced: 2021,
      },
      {
        id: "fwp-butterfly-effect",
        name: "Butterfly Effect",
        slug: "butterfly-effect",
        description:
          "Ferris Wheel Press's mid-range fountain pen with a larger, more substantial body than the Cricket. The Butterfly Effect features a smooth JoWo #6 steel nib, a screw cap, and ornate detailing inspired by Art Nouveau motifs. The barrel showcases Ferris Wheel Press's signature illustrative style. A step up in nib size and writing experience.",
        nibOptions: ["Extra Fine", "Fine", "Medium", "Broad", "Stub 1.1"],
        fillingSystem: "Cartridge / Converter",
        material: "Acrylic resin / Brass trim",
        knownPrices: [
          { retailer: "Amazon", price: 52.00, currency: "USD", url: "https://www.amazon.com/s?k=Ferris+Wheel+Press+Butterfly+Effect+fountain+pen", inStock: true, condition: "new" },
          { retailer: "Goulet Pens", price: 58.00, currency: "USD", url: "https://www.gouletpens.com/search?q=ferris+wheel+press+butterfly+effect", inStock: true, condition: "new" },
          { retailer: "Goldspot Pens", price: 56.00, currency: "USD", url: "https://www.goldspot.com/ferris-wheel-press/butterfly-effect/", inStock: true, condition: "new" },
        ],
        msrp: 58,
        yearIntroduced: 2022,
      },
  ...
  },
  {
    ...
    country: "Taiwan",
    description:
      "Founded in 2012 in Taipei, Taiwan, YStudio is a design-focused stationery brand known for minimalist, industrial-inspired fountain pens. Their pens are crafted from solid brass with a raw, unfinished aesthetic that develops a unique patina over time. YStudio has gained a strong following among design enthusiasts and fountain pen collectors who appreciate the blend of Taiwanese craftsmanship and modern aesthetics.",
    website: "https://www.ystudio.co",
    models: [
      {
        id: "ystudio-classic",
        ...
        slug: "classic",
        description:
          "YStudio's flagship fountain pen featuring a solid brass body with a distinctive raw, unfinished finish that develops a unique patina with use. The Classic has a smooth JoWo #5 steel nib and a satisfying weight in hand. Comes in a beautiful gift box with a converter and ink cartridge. A statement piece that blends industrial design with writing functionality.",
        nibOptions: ["Fine", "Medium"],
        fillingSystem: "Cartridge / Converter",
        material: "Solid brass",
        knownPrices: [
          { retailer: "Amazon", price: 78.00, currency: "USD", url: "https://www.amazon.com/s?k=YStudio+Classic+fountain+pen", inStock: true, condition: "new" },
          { retailer: "JetPens", price: 85.00, currency: "USD", url: "https://www.jetpens.com/search?q=YStudio+Classic+fountain+pen", inStock: true, condition: "new" },
          { retailer: "Goldspot Pens", price: 82.00, currency: "USD", url: "https://www.goldspot.com/ystudio/classic/", inStock: true, condition: "new" },
        ],
        msrp: 85,
        yearIntroduced: 2014,
      },
      {
        ...
        slug: "weight-of-city",
        description:
          "A pocket-sized brass fountain pen inspired by the weight and presence of urban architecture. The Weight of City is compact, with a screw cap and a smooth steel nib. The solid brass body gives it surprising heft for its size. Perfect for everyday carry, it develops a distinctive patina that tells the story of its use.",
        nibOptions: ["Fine", "Medium"],
        fillingSystem: "Cartridge / Converter",
        material: "Solid brass",
        knownPrices: [
          { retailer: "Amazon", price: 58.00, currency: "USD", url: "https://www.amazon.com/s?k=YStudio+Weight+of+City+fountain+pen", inStock: true, condition: "new" },
          { retailer: "JetPens", price: 65.00, currency: "USD", url: "https://www.jetpens.com/search?q=YStudio+Weight+of+City", inStock: true, condition: "new" },
        ],
        msrp: 65,
        yearIntroduced: 2016,
      },
