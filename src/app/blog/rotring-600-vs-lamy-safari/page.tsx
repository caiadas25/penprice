    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <nav className="text-sm text-slate-500 mb-8">
          ...
          <span className="mx-2">/</span>
          <span className="text-slate-400">Rotring 600 vs Lamy Safari</span>
        </nav>
        ...
        <article>
          ...
          <div className="bg-amber-950/30 border border-amber-900/50 rounded-lg p-6 mb-10">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-slate-300 text-sm">
              <div>
                <strong className="text-white">Choose the Rotring 600 if:</strong>
              ...
              <div>
                <strong className="text-white">Choose the Lamy Safari if:</strong>
                <ul className="mt-2 space-y-1 list-disc list-inside">
          ...
          <section className="mb-10">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-5">
                <h3 className="font-bold text-amber-400 mb-3">Rotring 600</h3>
                <ul className="space-y-2 text-sm">
                  <li className="flex justify-between text-slate-300">
                    <span>Amazon</span><span className="text-white font-medium">$99.99</span>
                  </li>
                  <li className="flex justify-between text-slate-300">
                    <span>JetPens</span><span className="text-white font-medium">$110.00</span>
                  </li>
                  <li className="flex justify-between text-slate-300">
                    <span>MSRP</span><span className="text-white font-medium">$120.00</span>
                  </li>
                </ul>
                <Link href="/brands/rotring/600" className="block mt-3 text-center text-sm text-amber-400 hover:underline">
                  View full price history →
                </Link>
              </div>
              <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-5">
                <h3 className="font-bold text-amber-400 mb-3">Lamy Safari</h3>
                <ul className="space-y-2 text-sm">
                  <li className="flex justify-between text-slate-300">
                    <span>Amazon</span><span className="text-white font-medium">$29.99</span>
                  </li>
                  <li className="flex justify-between text-slate-300">
                    <span>JetPens</span><span className="text-white font-medium">$30.00</span>
                  </li>
                  <li className="flex justify-between text-slate-300">
                    <span>Goulet Pens</span><span className="text-white font-medium">$30.00</span>
                  </li>
                </ul>
                <Link href="/brands/lamy/safari" className="block mt-3 text-center text-sm text-amber-400 hover:underline">
                  View full price history →
                </Link>
              </div>
            </div>
              ...
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="border-b border-slate-700">
                    ...
                    <th className="text-left py-3 px-4 text-amber-400 font-medium">Rotring 600</th>
                    <th className="text-left py-3 px-4 text-amber-400 font-medium">Lamy Safari</th>
                  </tr>
                </thead>
