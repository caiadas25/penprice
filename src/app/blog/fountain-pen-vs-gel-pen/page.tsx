  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-stone-400 mb-8">
        ...
        <span className="mx-2">/</span>
        <span className="text-stone-500">Fountain Pen vs Gel Pen</span>
      </nav>
      ...
      <article>
        ...
        <section className="mb-12">
          <h2 className="text-xl font-bold text-stone-900 mb-4">At a Glance</h2>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="border-b border-stone-200">
                  <th className="text-left py-3 px-4 text-stone-500 font-medium">Feature</th>
                  <th className="text-left py-3 px-4 text-blue-800 font-medium">Fountain Pen</th>
        ...
        {/* Writing Experience */}
        <section className="mb-12">
          <h2 className="text-xl font-bold text-stone-900 mb-4">Writing Experience</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 rounded border border-blue-200 bg-white">
              <h3 className="text-lg font-bold text-blue-800 mb-3">Fountain Pen ✒️</h3>
        ...
        {/* Cost Analysis */}
        <section className="mb-12">
          <h2 className="text-xl font-bold text-stone-900 mb-4">Cost Analysis</h2>
          ...
          <div className="space-y-3">
            <div className="p-4 rounded border border-stone-200 bg-white">
              <p className="text-stone-900 font-medium mb-1">Casual Writer (1-2 pages/week)</p>
              <p className="text-stone-500 text-sm">
                A Pilot Metropolitan ($25) + Pilot Blue-Black ink ($15) will last you over a year.
                <span className="text-blue-800 ml-2">Fountain pen wins.</span>
              </p>
            </div>
            <div className="p-4 rounded border border-stone-200 bg-white">
              <p className="text-stone-900 font-medium mb-1">Daily Note-Taker (5+ pages/day)</p>
              <p className="text-stone-500 text-sm">
                A TWSBI ECO ($35) + Noodler&apos;s Heart of Darkness ($25) handles thousands of pages.
                <span className="text-blue-800 ml-2">Fountain pen wins big.</span>
              </p>
            </div>
            <div className="p-4 rounded border border-stone-200 bg-white">
              <p className="text-stone-900 font-medium mb-1">Occasional Use / Forms & Signatures</p>
              <p className="text-stone-500 text-sm">
        ...
        <section className="mb-12">
          <h2 className="text-xl font-bold text-stone-900 mb-4">Who Should Choose What?</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 rounded border border-blue-200 bg-amber-900/5">
              <h3 className="text-lg font-bold text-blue-800 mb-3">Choose a Fountain Pen If...</h3>
            ...
            <div className="p-6 rounded border border-blue-200 bg-blue-900/5">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold text-stone-900 mb-2">Are fountain pens better than gel pens?</h3>
              <p className="text-stone-500 text-sm leading-relaxed">
            ...
            <div>
              <h3 className="font-semibold text-stone-900 mb-2">Can fountain pens write on any paper?</h3>
              <p className="text-stone-500 text-sm leading-relaxed">
            ...
            <div>
              <h3 className="font-semibold text-stone-900 mb-2">How long does a fountain pen ink cartridge last?</h3>
              <p className="text-stone-500 text-sm leading-relaxed">
            ...
            <div>
              <h3 className="font-semibold text-stone-900 mb-2">Are gel pens good for handwriting practice?</h3>
              <p className="text-stone-500 text-sm leading-relaxed">
        ...
        {/* Best Picks */}
        <section className="mb-12">
          <h2 className="text-xl font-bold text-stone-900 mb-4">Recommended Picks</h2>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Link
              ...
              className="p-4 rounded border border-stone-200 bg-white hover:border-blue-300 transition-all group"
            >
              <p className="text-xs text-blue-800 mb-1">Best Budget Fountain Pen</p>
              <p className="text-stone-900 font-bold group-hover:text-blue-800 transition-colors">Pilot Metropolitan</p>
              <p className="text-stone-400 text-sm">From $25 · Brass body · Gold-feel steel nib</p>
            </Link>
            <Link
              href="/brands/twsbi/eco"
              className="p-4 rounded border border-stone-200 bg-white hover:border-blue-300 transition-all group"
            >
              <p className="text-xs text-blue-800 mb-1">Best Value Piston Filler</p>
              <p className="text-stone-900 font-bold group-hover:text-blue-800 transition-colors">TWSBI ECO</p>
              <p className="text-stone-400 text-sm">From $32 · Massive ink capacity · Transparent body</p>
            </Link>
            <Link
              href="/brands/lamy/safari"
              className="p-4 rounded border border-stone-200 bg-white hover:border-blue-300 transition-all group"
            >
              <p className="text-xs text-blue-800 mb-1">Best Beginner Fountain Pen</p>
              <p className="text-stone-900 font-bold group-hover:text-blue-800 transition-colors">Lamy Safari</p>
              <p className="text-stone-400 text-sm">From $30 · Triangular grip · Iconic design</p>
            </Link>
            <Link
              href="/brands/platinum/preppy"
              className="p-4 rounded border border-stone-200 bg-white hover:border-blue-300 transition-all group"
            >
              <p className="text-xs text-blue-800 mb-1">Cheapest Quality Fountain Pen</p>
              <p className="text-stone-900 font-bold group-hover:text-blue-800 transition-colors">Platinum Preppy</p>
              <p className="text-stone-400 text-sm">From $7 · Slip & Seal cap · Eyedropper convertible</p>
            </Link>
          </div>
        </section>
        ...
        <section className="border-t border-stone-200 pt-8">
          <h2 className="text-sm font-semibold text-stone-400 uppercase tracking-wide mb-4">Related Guides</h2>
          <div className="grid md:grid-cols-2 gap-4">
            <Link href="/blog/fountain-pen-vs-ballpoint" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all">
              <p className="text-stone-900 font-medium hover:text-blue-800 transition-colors">Fountain Pen vs Ballpoint Pen</p>
              <p className="text-stone-400 text-sm mt-1">How do fountain pens compare to traditional ballpoints?</p>
            </Link>
            <Link href="/blog/best-fountain-pens-for-beginners" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all">
              <p className="text-stone-900 font-medium hover:text-blue-800 transition-colors">Best Fountain Pens for Beginners</p>
              <p className="text-stone-400 text-sm mt-1">Our top picks for your first fountain pen purchase.</p>
            </Link>
            <Link href="/blog/fountain-pen-maintenance-guide" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all">
              <p className="text-stone-900 font-medium hover:text-blue-800 transition-colors">Fountain Pen Maintenance Guide</p>
              <p className="text-stone-400 text-sm mt-1">How to clean and care for your fountain pen.</p>
            </Link>
            <Link href="/blog/fountain-pen-filling-systems-explained" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all">
              <p className="text-stone-900 font-medium hover:text-blue-800 transition-colors">Filling Systems Explained</p>
              <p className="text-stone-400 text-sm mt-1">Cartridge vs piston vs vacuum: every filling system compared.</p>
            </Link>
          </div>
        </section>
      </article>
