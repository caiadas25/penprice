          ...
          {recommendations.map((pen) => (
            ...
            >
              ...
              <div className="flex gap-3 flex-wrap">
                ...
                <Link
                  href={`/brands/${pen.brandSlug}`}
                  className="text-sm px-3 py-1.5 rounded border border-stone-200 text-stone-700 hover:border-blue-300 hover:text-blue-800 transition-colors"
                >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-5 rounded border border-stone-200 bg-white">
              ...
              <p className="text-stone-500 text-sm">
                The <strong className="text-stone-900">Lamy 2000</strong> ($180) offers a piston filler and 14k gold
            ...
            <div className="p-5 rounded border border-stone-200 bg-white">
              ...
              <p className="text-stone-500 text-sm">
                The <strong className="text-stone-900">Pilot Custom 823</strong> ($290) has the best nib in this
            ...
            <div className="p-5 rounded border border-stone-200 bg-white">
              ...
              <p className="text-stone-500 text-sm">
                The <strong className="text-stone-900">Sailor Pro Gear</strong> ($296) has a 21k gold nib with
            ...
            <div className="p-5 rounded border border-stone-200 bg-white">
              ...
              <p className="text-stone-500 text-sm">
                The <strong className="text-stone-900">TWSBI Diamond 580</strong> ($63) and{" "}
                <strong className="text-stone-900">Pilot Custom 823</strong> ($290) both offer huge ink
