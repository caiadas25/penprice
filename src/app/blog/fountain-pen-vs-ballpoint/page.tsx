  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-stone-400 mb-8">
        ...
        <span className="mx-2">/</span>
        <span className="text-stone-500">Fountain Pen vs Ballpoint</span>
      </nav>
      ...
      <article>
        ...
        <div className="bg-white border border-stone-200 rounded p-6 mb-10">
          ...
          <ul className="space-y-2 text-sm text-stone-700">
            <li><span className="text-blue-800 font-semibold">Choose a ballpoint if:</span> You want zero maintenance, write occasionally, and need it to work on any paper.</li>
            <li><span className="text-blue-800 font-semibold">Choose a fountain pen if:</span> You write daily, value the writing experience, and want a more personal writing tool.</li>
            <li><span className="text-blue-800 font-semibold">The truth:</span> Both are excellent tools. The best pen is the one you enjoy writing with.</li>
          </ul>
        </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-stone-200">
                  ...
                  <th className="text-left py-3 px-4 text-stone-500 font-medium">Ballpoint Pen</th>
                </tr>
              </thead>
              <tbody className="text-stone-700">
                <tr className="border-b border-stone-200/50">
                  <td className="py-3 px-4 font-medium text-stone-900">Writing feel</td>
                ...
                <tr className="border-b border-stone-200/50">
                  <td className="py-3 px-4 font-medium text-stone-900">Ink cost per page</td>
                  <td className="py-3 px-4">~$0.01-0.03 per page (bottled ink)</td>
                  <td className="py-3 px-4">~$0.001-0.005 per page</td>
                </tr>
                <tr className="border-b border-stone-200/50">
                  <td className="py-3 px-4 font-medium text-stone-900">Maintenance</td>
        ...
        {/* Writing Experience */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-stone-900 mb-4">The Writing Experience</h2>
          <div className="prose prose-invert max-w-none space-y-4 text-stone-700 text-sm leading-relaxed">
            <p>
              <strong className="text-stone-900">Fountain pens write with almost no pressure.</strong> The
            ...
            <p>
              <strong className="text-stone-900">Ballpoint pens require downward pressure.</strong> The
            ...
            <p>
              <strong className="text-stone-900">The nib size matters enormously.</strong> Fountain pens
        ...
        {/* Cost */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-stone-900 mb-4">The Cost Equation</h2>
          <div className="prose prose-invert max-w-none space-y-4 text-stone-700 text-sm leading-relaxed">
            <p>
              <strong className="text-stone-900">Upfront cost favors ballpoints.</strong> A decent ballpoint
            ...
            <p>
              <strong className="text-stone-900">Fountain pens are more economical for daily writers.</strong> If
            ...
            <p>
              <strong className="text-stone-900">Ballpoints win on convenience.</strong> No need to buy
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-stone-900 mb-4">Who Should Choose a Fountain Pen?</h2>
          <div className="grid gap-4">
            <div className="bg-white border border-stone-200 rounded p-5">
              <h3 className="font-semibold text-stone-900 mb-2">Daily writers and journalers</h3>
            ...
            <div className="bg-white border border-stone-200 rounded p-5">
              <h3 className="font-semibold text-stone-900 mb-2">Creatives and artists</h3>
              <p className="text-sm text-stone-700">
            ...
            <div className="bg-white border border-stone-200 rounded p-5">
              <h3 className="font-semibold text-stone-900 mb-2">People who value the writing ritual</h3>
              <p className="text-sm text-stone-700">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-stone-900 mb-4">Who Should Stick with Ballpoints?</h2>
          <div className="grid gap-4">
            <div className="bg-white border border-stone-200 rounded p-5">
              <h3 className="font-semibold text-stone-900 mb-2">Occasional writers</h3>
              <p className="text-sm text-stone-700">
            ...
            <div className="bg-white border border-stone-200 rounded p-5">
              <h3 className="font-semibold text-stone-900 mb-2">People who write on any paper</h3>
              <p className="text-sm text-stone-700">
            ...
            <div className="bg-white border border-stone-200 rounded p-5">
              <h3 className="font-semibold text-stone-900 mb-2">Zero-maintenance writers</h3>
              <p className="text-sm text-stone-700">
        ...
        {/* Bottom Line */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-stone-900 mb-4">The Bottom Line</h2>
          <div className="prose prose-invert max-w-none space-y-4 text-stone-700 text-sm leading-relaxed">
            <p>
              <strong className="text-stone-900">A fountain pen is not objectively better than a ballpoint.</strong> It&apos;s
            ...
            <p>
              <strong className="text-stone-900">The best way to decide is to try one.</strong> Pick up a
        ...
        <section className="border-t border-stone-200 pt-8">
          <h2 className="text-lg font-bold text-stone-900 mb-4">Get Started with Fountain Pens</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link href="/blog/best-fountain-pens-for-beginners" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all text-sm">
              ...
              <span className="block text-stone-400 mt-1">Start here if you&apos;re new to fountain pens</span>
            </Link>
            <Link href="/blog/best-fountain-pens-under-20" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all text-sm">
              ...
              <span className="block text-stone-400 mt-1">Try a fountain pen for under $20</span>
            </Link>
            <Link href="/blog/fountain-pen-nib-sizes-explained" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all text-sm">
              ...
              <span className="block text-stone-400 mt-1">Fine, Medium, Broad — what&apos;s the difference?</span>
            </Link>
            <Link href="/blog/fountain-pen-maintenance-guide" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all text-sm">
              <span className="text-stone-900 font-semibold">Maintenance Guide →</span>
