...
function PenCard({ pen }: { pen: PenRecommendation }) {
  ...
  return (
    <div className="bg-white border border-stone-200 rounded p-5 hover:border-blue-300 transition-all">
      <div className="flex justify-between items-start mb-3">
        <div>
          ...
          <p className="text-sm text-stone-500">{brand?.name} &middot; {brand?.country}</p>
        </div>
        <div className="text-right">
          <p className="text-blue-800 font-bold text-lg">From ${pen.priceFrom.toFixed(2)}</p>
          {model?.msrp && (
            <p className="text-xs text-stone-400">MSRP ${model.msrp}</p>
          )}
        </div>
      </div>
      <p className="text-sm text-stone-700 leading-relaxed mb-3">{pen.why}</p>
      {model && (
        <div className="flex flex-wrap gap-2">
          {model.knownPrices.map((price) => (
            <a
              ...
              className="text-xs bg-stone-100 text-stone-700 px-3 py-1 rounded hover:bg-stone-200 hover:text-stone-900 transition-colors"
            >
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-stone-400 mb-8">
        ...
        <span className="mx-2">/</span>
        <span className="text-stone-500">Best Fountain Pens Under $100</span>
      </nav>
      ...
      <article>
        ...
        <div className="bg-white border border-stone-200 rounded p-6 mb-10">
          ...
          <ul className="space-y-2 text-sm text-stone-700">
            <li><span className="text-blue-800 font-semibold">Best gold nib under $100:</span> Pilot Custom 74 — 14k gold nib at ~$72, incredible value</li>
            <li><span className="text-blue-800 font-semibold">Best demonstrator:</span> TWSBI Diamond 580 — piston filler, faceted body, massive ink capacity</li>
            <li><span className="text-blue-800 font-semibold">Best everyday carry:</span> Kaweco Dia2 — compact brass pen, snap cap, vintage design</li>
            <li><span className="text-blue-800 font-semibold">Best for small handwriting:</span> Sailor Pro Gear Slim — legendary 21k nib with precise feedback</li>
            <li><span className="text-blue-800 font-semibold">Best magnetic cap:</span> Monteverde Ritma — hexagonal steel body, magnetic closure</li>
            <li><span className="text-blue-800 font-semibold">Best value under $60:</span> Conklin Duragraph — robust build, smooth nib, dozens of colors</li>
          </ul>
        </div>
        ...
        {/* Buyer's Guide */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-stone-900 mb-4">Buying Guide: Gold vs Steel Nibs</h2>
          <div className="prose prose-invert max-w-none space-y-4 text-stone-700 text-sm leading-relaxed">
            <p>
              <strong className="text-stone-900">The $50-$100 range is where gold nibs start appearing.</strong> A
            ...
            <p>
              <strong className="text-stone-900">Don&apos;t overlook steel nibs at this price.</strong> The
            ...
            <p>
              <strong className="text-stone-900">Filling systems matter more here.</strong> Under $50, most pens
            ...
            <p>
              <strong className="text-stone-900">Limited editions are everywhere.</strong> Sailor and TWSBI release
            ...
            <p>
              <strong className="text-stone-900">Check retailer prices.</strong> The same pen can vary by $10-20
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-stone-900 mb-2">What is the best fountain pen under $100?</h3>
              <p className="text-sm text-stone-700 leading-relaxed">
                The <Link href="/brands/pilot/custom-74" className="text-blue-800 hover:underline">Pilot Custom 74</Link> is
            ...
            <div>
              <h3 className="text-lg font-semibold text-stone-900 mb-2">Are gold nibs worth it under $100?</h3>
              <p className="text-sm text-stone-700 leading-relaxed">
            ...
            <div>
              <h3 className="text-lg font-semibold text-stone-900 mb-2">Should I buy a fountain pen from Amazon?</h3>
              <p className="text-sm text-stone-700 leading-relaxed">
                ...
                with <Link href="/brands/lamy/safari" className="text-blue-800 hover:underline">specialty retailers</Link> like
        ...
        <section className="border-t border-stone-200 pt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link href="/blog/best-fountain-pens-under-50" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all text-sm">
              <span className="text-stone-900 font-semibold">Best Under $50 →</span>
              <span className="block text-stone-400 mt-1">Budget picks: Pilot Metropolitan, TWSBI Eco, Kaweco Sport</span>
            </Link>
            <Link href="/blog/best-fountain-pens-under-20" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all text-sm">
              <span className="text-stone-900 font-semibold">Best Under $20 →</span>
              <span className="block text-stone-400 mt-1">Ultra-budget: Platinum Preppy, Jinhao X450, Noodler&apos;s Ahab</span>
            </Link>
            <Link href="/blog/best-japanese-fountain-pens" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all text-sm">
              <span className="text-stone-900 font-semibold">Best Japanese Pens →</span>
              <span className="block text-stone-400 mt-1">Pilot, Sailor, Platinum, TWSBI — Japan dominates fountain pens</span>
            </Link>
            <Link href="/brands/sailor" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all text-sm">
              <span className="text-stone-900 font-semibold">All Sailor Pens →</span>
              <span className="block text-stone-400 mt-1">1911, Pro Gear, King of Pens — legendary gold nibs</span>
            </Link>
            <Link href="/brands/pilot" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all text-sm">
              ...
              <span className="block text-stone-400 mt-1">Metropolitan, Custom 74, Custom 823, Vanishing Point</span>
            </Link>
            <Link href="/blog/fountain-pen-nib-sizes-explained" className="p-4 rounded border border-stone-200 hover:border-blue-300 transition-all text-sm">
              ...
              <span className="block text-stone-400 mt-1">Japanese vs Western nib sizes, gold vs steel, specialty nibs</span>
            </Link>
          </div>
        </section>
      </article>
