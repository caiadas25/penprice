  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-slate-500 mb-8">
        ...
        <span className="mx-2">/</span>
        <span className="text-slate-400">Best Fountain Pens for Beginners</span>
      </nav>

      <article>
        <header className="mb-10">
          <p className="text-amber-400 text-sm font-medium mb-2">Beginner Guide — Updated June 2026</p>
        ...
        <div className="bg-slate-800/60 border border-slate-700 rounded-xl p-6 mb-10">
          <h2 className="text-lg font-bold text-white mb-3">Quick Start: 3 Things to Know</h2>
          <ul className="space-y-3 text-sm text-slate-300">
            <li>
              <span className="text-amber-400 font-semibold">1. Nib size matters more than brand.</span>{" "}
            ...
            <li>
              <span className="text-amber-400 font-semibold">2. Start with cartridges.</span>{" "}
            ...
            <li>
              <span className="text-amber-400 font-semibold">3. Paper matters as much as the pen.</span>{" "}
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-6">Top 10 Beginner Fountain Pens</h2>
        ...
        {/* Nib Guide */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-4">Understanding Nib Sizes</h2>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm border border-slate-700 rounded-lg overflow-hidden">
                <thead className="bg-slate-800">
                  <tr>
                    <th className="px-4 py-2 text-left text-slate-300 font-semibold">Size</th>
                    <th className="px-4 py-2 text-left text-slate-300 font-semibold">Japanese (Pilot)</th>
                    <th className="px-4 py-2 text-left text-slate-300 font-semibold">Western (Lamy)</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-700">
                  <tr><td className="px-4 py-2 text-slate-400">Extra Fine</td><td className="px-4 py-2 text-slate-300">~0.28mm</td><td className="px-4 py-2 text-slate-300">~0.4mm</td></tr>
                  <tr><td className="px-4 py-2 text-slate-400">Fine</td><td className="px-4 py-2 text-slate-300">~0.38mm</td><td className="px-4 py-2 text-slate-300">~0.5mm</td></tr>
                  <tr><td className="px-4 py-2 text-slate-400">Medium</td><td className="px-4 py-2 text-slate-300">~0.5mm</td><td className="px-4 py-2 text-slate-300">~0.6mm</td></tr>
                  <tr><td className="px-4 py-2 text-slate-400">Broad</td><td className="px-4 py-2 text-slate-300">~0.6mm</td><td className="px-4 py-2 text-slate-300">~0.8mm</td></tr>
                </tbody>
              </table>
            </div>
            <p>
              <strong className="text-white">Recommendation:</strong> If you have small handwriting or write
        ...
        {/* Filling Systems */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-4">Filling Systems Explained</h2>
          <div className="grid gap-4 text-sm">
            <div className="p-4 rounded-lg border border-slate-700 bg-slate-800/30">
              <h3 className="font-bold text-white mb-2">Cartridge</h3>
              <p className="text-slate-400">Snap in a pre-filled ink cartridge. Easiest option for beginners. Pilot, Lamy, and Platinum each use proprietary cartridge sizes.</p>
            </div>
            <div className="p-4 rounded-lg border border-slate-700 bg-slate-800/30">
              <h3 className="font-bold text-white mb-2">Converter</h3>
              <p className="text-slate-400">A reusable cartridge that lets you use bottled ink. Most cartridge pens can accept a converter. More ink choices, lower cost per fill.</p>
            </div>
            <div className="p-4 rounded-lg border border-slate-700 bg-slate-800/30">
              <h3 className="font-bold text-white mb-2">Piston Filler</h3>
              <p className="text-slate-400">Built-in mechanism that draws ink directly from a bottle. Maximum ink capacity. Examples: TWSBI Eco, Lamy 2000, Pelikan M800.</p>
            </div>
            <div className="p-4 rounded-lg border border-slate-700 bg-slate-800/30">
              <h3 className="font-bold text-white mb-2">Vacuum Filler</h3>
              <p className="text-slate-400">Uses a plunger to create a vacuum and draw ink. Massive ink capacity. Examples: Pilot Custom 823, TWSBI Vac 700R.</p>
            </div>
          </div>
        </section>
        ...
        <section className="border-t border-slate-700 pt-8">
          <h2 className="text-lg font-bold text-white mb-4">Compare Prices</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link href="/blog/best-fountain-pens-under-50" className="p-4 rounded-lg border border-slate-700 hover:border-amber-600/50 transition-all text-sm">
              ...
              <span className="block text-slate-500 mt-1">Budget-friendly picks with live price comparisons</span>
            </Link>
            ...
            <Link href="/brands" className="p-4 rounded-lg border border-slate-700 hover:border-amber-600/50 transition-all text-sm">
              <span className="text-white font-semibold">Browse All Brands →</span>
