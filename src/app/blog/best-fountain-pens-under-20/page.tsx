  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-stone-400 mb-8">
        ...
        <span className="mx-2">/</span>
        <span className="text-stone-500">Best Fountain Pens Under $20</span>
      </nav>
      ...
      <article className="prose prose-invert max-w-none">
        <h2 className="text-2xl font-bold text-stone-900 mt-8 mb-4">Why Fountain Pens Under $20?</h2>
        ...
        <h2 className="text-2xl font-bold text-stone-900 mt-8 mb-4">The Best Picks</h2>
        ...
        <div className="space-y-6 not-prose">
          {recommendations.map((pen) => {
            ...
            return (
              <div key={pen.slug} className="p-5 rounded border border-stone-200 bg-white">
                ...
                <p className="text-stone-500 text-sm mb-3">{pen.why}</p>
                <div className="flex items-center gap-3">
                  ...
                  <Link
                    href={`/brands/${pen.brandSlug}/${pen.slug}`}
                    className="text-xs px-3 py-1.5 rounded bg-stone-100 text-stone-700 hover:bg-stone-200 transition-colors"
                  >
                    See all retailers →
                  </Link>
                </div>
        ...
        <h2 className="text-2xl font-bold text-stone-900 mt-8 mb-4">What to Expect at This Price</h2>
        <p className="text-stone-700 leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-bold text-stone-900 mt-8 mb-4">Tips for Buying Budget Fountain Pens</h2>
        <ul className="text-stone-700 space-y-2 list-disc list-inside">
          ...
          <li>Check our <Link href="/blog/fountain-pen-maintenance-guide" className="text-blue-800 hover:underline">maintenance guide</Link> to keep your pen writing smoothly</li>
        </ul>

        <h2 className="text-2xl font-bold text-stone-900 mt-8 mb-4">Frequently Asked Questions</h2>
        ...
        <div className="space-y-4 not-prose">
          {[
            ...
            <div key={i} className="p-4 rounded border border-stone-200 bg-white">
        ...
        <div className="mt-10 p-6 rounded border border-amber-800/50 bg-amber-900/20">
          <h3 className="text-lg font-bold text-stone-900 mb-2">Related Guides</h3>
          <ul className="space-y-1 text-sm">
            <li><Link href="/blog/best-fountain-pens-for-beginners" className="text-blue-800 hover:underline">Best Fountain Pens for Beginners</Link></li>
            <li><Link href="/blog/best-fountain-pens-under-50" className="text-blue-800 hover:underline">Best Fountain Pens Under $50</Link></li>
            <li><Link href="/blog/lamy-safari-vs-pilot-metropolitan" className="text-blue-800 hover:underline">Lamy Safari vs Pilot Metropolitan</Link></li>
            <li><Link href="/blog/fountain-pen-filling-systems-explained" className="text-blue-800 hover:underline">Fountain Pen Filling Systems Explained</Link></li>
          </ul>
        </div>
      </article>
