...
- Created `/blog/best-fountain-pens-for-calligraphy` — high-intent keyword target
  - 8 pen recommendations across flex nibs, stub nibs, and soft nibs
  - Nib types explained (flex, stub/italic, soft)
  - Best inks for calligraphy section (Baystate Blue, Iroshizuku, Diamine)
  - Best paper for calligraphy section (Rhodia, Clairefontaine, Tomoe River)
  - FAQ with 3 questions and FAQPage JSON-LD schema
  - Article JSON-LD schema
  - Internal links to nib sizes, beginners, inks, and under-50 guides
- Added Edison (USA) brand: Beaumont ($149), Collier ($199)
- Updated visuals.ts with Edison brand color
- Updated layout metadata: 46 brands, 120+ models

### Keywords targeted
- "best fountain pen for calligraphy" (new blog post — high-intent keyword)
- "fountain pen calligraphy" (blog content)
- "flex nib fountain pen" (blog content)
- "stub nib fountain pen" (blog content)
- "Noodler's Ahab calligraphy" (blog content)
- "Pilot Falcon flex nib" (blog content)
- "Edison Beaumont fountain pen price" (new model page)
- "Edison Collier fountain pen" (new model page)
